...
namespace ShoppingCartGrpc.Services
{
    ...
    public class ShoppingCartService : ShoppingCartProtoService.ShoppingCartProtoServiceBase
    {
        ...
        {
            _shoppingCartDbContext =
                shoppingCartDbContext ?? throw new ArgumentNullException(nameof(shoppingCartDbContext));
            ...
            IAsyncStreamReader<AddItemIntoShoppingCartRequest> requestStream, ServerCallContext context)
        {
            while (await requestStream.MoveNext())
            {
                ...
                var shoppingCart =
                    await _shoppingCartDbContext.ShoppingCart.FirstOrDefaultAsync(s =>
        ...
        [AllowAnonymous]
        public override async Task<RemoveItemIntoShoppingCartResponse> RemoveItemIntoShoppingCart(
